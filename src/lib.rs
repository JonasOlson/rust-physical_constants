...
mod tests {
    ...
    fn test_no_exponent() {
        ...
        assert_eq!(ATOMIC_MASS_CONSTANT_ENERGY_EQUIVALENT_IN_MEV, 931.4940954);
    }

    #[test]
    fn test_positive_exponent() {
        assert_eq!(BOLTZMANN_CONSTANT_IN_HZ_PER_K, 2.0836612e10);
    }

    #[test]
    fn test_negative_exponent() {
        assert_eq!(CLASSICAL_ELECTRON_RADIUS, 2.8179403227e-15);
    }

    #[test]
    fn test_negative_value() {
        assert_eq!(ELECTRON_CHARGE_TO_MASS_QUOTIENT, -1.758820024e11);
    }

    #[test]
    fn test_dimensionless_value() {
        assert_eq!(PROTON_ELECTRON_MASS_RATIO, 1836.15267389);
    }
    ...
    fn test_last_quantity() {
        ...
        assert_eq!(WIEN_WAVELENGTH_DISPLACEMENT_LAW_CONSTANT, 2.8977729e-3);
    }
